      ...
      do f = 1, fn
         ...
         do iv = 1, nrad(p)
            ...
            if (par_z(p,iv) <= 0._r8) then           ! night time
               ...
               vcmaxse = (668.39_r8 - 1.07_r8 * min(max((t10(p)-tfrz),11._r8),35._r8)) * this_vcmaxse_sf
               jmaxse  = (659.70_r8 - 0.75_r8 * min(max((t10(p)-tfrz),11._r8),35._r8)) * this_jmaxse_sf
               tpuse = vcmaxse * this_tpuse_sf
