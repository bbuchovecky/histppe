...
NAMELISTS="/glade/u/home/bbuchovecky/projects/cpl_ppe_co2/scripts/testing/coupPPE.test.000/namelists"
NAMELISTMODS="/glade/u/home/bbuchovecky/projects/cpl_ppe_co2/pert/testing/coupPPE.test.000/nlmods"
PARAMFILES="/glade/u/home/bbuchovecky/projects/cpl_ppe_co2/pert/testing/coupPPE.test.000/paramfiles"
SOURCEMODS="/glade/u/home/bbuchovecky/projects/cpl_ppe_co2/pert/testing/coupPPE.test.000/srcmods/perturbed"
...
BASEFNAME="$(pwd)/$(basename "${0%.*}")"
exec > >(tee -a "${BASEFNAME}.log") 2>&1
echo "${BASEFNAME}.sh"
echo $USER
date +%y-%m-%dT%H:%M:%S
